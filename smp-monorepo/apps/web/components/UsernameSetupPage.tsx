  ...
  return (
    <div className="w-full min-h-screen relative flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-lg mx-auto py-2">
        <Card className="bg-black/90 backdrop-blur-sm border-blue-500/50 shadow-2xl shadow-blue-700/40">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-2">
              <div className="bg-blue-950/50 border border-blue-600/30 rounded-lg p-4 mb-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-black/70 border-blue-500/50 text-white placeholder:text-gray-400 focus:border-blue-400 focus:bg-black/80"
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.hunterClass} onValueChange={(value: string) => setFormData({...formData, hunterClass: value})}>
                  <SelectTrigger className="bg-black/70 border-blue-500/50 text-white focus:border-blue-400">
                  ...
                  <SelectContent className="bg-black/95 border-blue-500/50">
                    {hunterClasses.map((hunterClass) => (
                      <SelectItem 
                        ...
                        className="text-white hover:bg-blue-800/50 focus:bg-blue-800/50"
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-blue-700 to-cyan-700 hover:from-blue-800 hover:to-cyan-800 text-white shadow-xl shadow-blue-600/30 py-6 disabled:opacity-50"
                size="lg"
              >
                {isCreating ? (
                  <>
            ...
            {/* Info Box */}
            <div className="mt-6 bg-slate-950/60 border border-blue-600/30 rounded-lg p-4">
        ...
        <div className="absolute -top-3 -right-6 bg-black/90 backdrop-blur-sm border border-blue-500/50 rounded-lg p-3 shadow-lg">
          <div className="text-center">
            <p className="text-blue-300 text-xs">Starting Rank</p>
            <p className="text-white font-bold text-lg">E</p>
          </div>
        </div>

        {/* Floating Level Display */}
        <div className="absolute -bottom-1 -left-4 bg-black/90 backdrop-blur-sm border border-blue-500/50 rounded-lg p-3 shadow-lg">
          <div className="text-center">
            <p className="text-blue-300 text-xs">Level</p>
