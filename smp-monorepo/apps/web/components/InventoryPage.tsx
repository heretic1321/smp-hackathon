        ...
        <main className="flex-1 px-4 sm:px-6 pb-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="text-blue-300">Manage your relics and equipment</p>
            </div>
                          ...
                          <CardContent className="p-4">
                            <div className="relative mb-3">
                              <ImageWithFallback
                                src={relic.imageUrl}
                                alt={relic.name}
                                className="w-full h-32 object-cover rounded-lg bg-gradient-to-br from-blue-800/50 to-cyan-800/50"
                              />
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-1">
                                  ...
                                  <span className="text-sm text-blue-300">{relic.type}</span>
                                </div>
                              </div>
        ...
        <div className="space-y-6 pr-4">
          ...
          <div className="relative">
            <ImageWithFallback
              src={relic.imageUrl}
              alt={relic.name}
              className="w-full h-48 object-cover rounded-lg bg-gradient-to-br from-blue-800/50 to-cyan-800/50"
            />
