        ...
        <main className="flex-1 px-4 sm:px-6 pb-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="text-blue-300">Trade relics with other hunters using ETH</p>
            </div>

            {/* Tabs */}
            <Tabs value={selectedTab} onValueChange={(value) => setSelectedTab(value as 'browse' | 'sell')} className="w-full">
              <TabsList className="grid w-full grid-cols-2 bg-black/80 border border-blue-600/30">
                <TabsTrigger value="browse" className="data-[state=active]:bg-blue-700/60 text-white">
                  <ShoppingCart className="w-4 h-4 mr-2" />
                  Browse & Buy
                </TabsTrigger>
                <TabsTrigger value="sell" className="data-[state=active]:bg-blue-700/60 text-white">
                        ...
                        <CardContent className="p-4">
                          <div className="relative mb-3">
                            <ImageWithFallback
                              ...
                              className="w-full h-32 object-cover rounded-lg bg-gradient-to-br from-blue-800/50 to-indigo-800/50"
                            />
                            ...
                            <div className="absolute bottom-2 left-2 right-2">
                              <div className="bg-black/80 backdrop-blur-sm rounded px-2 py-1">
                                <p className="text-xs text-blue-300">Seller: {listing.seller}</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-1">
                                ...
                                <span className="text-sm text-blue-300">{listing.relic.type}</span>
                              </div>
                            </div>
              ...
              <TabsContent value="sell" className="mt-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    {loading && (
                      <div className="flex flex-col items-center justify-center py-12">
                        ...
                        <p className="text-blue-300">Loading your inventory...</p>
                      </div>
                    )}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-96 overflow-y-auto">
                        {userRelics.length === 0 ? (
                          <div className="col-span-2 text-center py-12">
                            ...
                            <Button
                              variant="outline"
                              className="border-blue-500/50 text-blue-300 hover:bg-blue-800/40"
                                ...
                                <CardContent className="p-3">
                                  <div className="relative mb-2">
                                    <ImageWithFallback
                                      src={relic.imageUrl}
                                      alt={relic.name}
                                      className="w-full h-24 object-cover rounded-lg bg-gradient-to-br from-blue-800/50 to-indigo-800/50"
                                    />
                                  ...
                                  <div className="flex items-center justify-between mt-1">
                                    <div className="flex items-center space-x-1">
                                      ...
                                      <span className="text-xs text-blue-300">{relic.type}</span>
                                    </div>
                                  </div>
                  ...
                  <div>
                    ...
                    {selectedRelicToSell ? (
                      <Card className="bg-black/90 border-blue-600/30">
                        <CardHeader>
                        ...
                        <CardContent className="space-y-6">
                          <div className="relative">
                            <ImageWithFallback
                              ...
                              className="w-full h-48 object-cover rounded-lg bg-gradient-to-br from-blue-800/50 to-indigo-800/50"
                            />
                          </div>

                          <div className="space-y-4">
                            <div>
                              <Label htmlFor="price" className="text-blue-300">Price (ETH)</Label>
                              <Input
                                id="price"
                                type="number"
                                step="0.001"
                                ...
                                className="bg-blue-950/50 border-blue-600/50 text-white placeholder:text-gray-400"
                              />
                            ...
                            <Button
                              className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white shadow-xl hover:shadow-blue-500/25 transition-all duration-200 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
...
function RelicDetailsModal({ relic }: { relic: Relic }) {
  ...
  return (
    <DialogContent className="bg-black/95 border-blue-500/50 text-white max-w-2xl max-h-[80vh]">
      <DialogHeader>
        <DialogTitle className="text-2xl text-white flex items-center">
          <TypeIcon className="w-6 h-6 mr-2 text-blue-400" />
          {relic.name}
        </DialogTitle>
      ...
      <ScrollArea className="max-h-[60vh]">
        <div className="space-y-6 pr-4">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div>
              <p className="text-sm text-blue-300 mb-1">Type</p>
          ...
          <div>
            ...
            <div className="bg-blue-950/50 border border-blue-600/30 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <span className="text-blue-300">Estimated Value:</span>
